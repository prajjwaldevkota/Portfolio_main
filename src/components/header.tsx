  ...
  return (
    <header
      className={cn(
        ...
        isScrolled 
          ? "bg-background/30 backdrop-blur-xl border-b border-white/10 shadow-2xl shadow-black/5" 
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="flex justify-between items-center py-4">
          <Link 
            href="/" 
            className="text-xl font-bold tracking-tight bg-gradient-to-r from-violet-600 to-blue-600 bg-clip-text text-transparent hover:from-violet-500 hover:to-blue-500 transition-all duration-300 hover:scale-105"
          >
            Prajjwal Devkota
          </Link>
          ...
          <nav className="hidden md:flex items-center space-x-1">
            ...
            <div className="ml-6 p-1 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300">
              <ThemeToggle />
            </div>
          </nav>
          ...
          <div className="md:hidden flex items-center space-x-3">
            <div className="p-1 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10">
              <ThemeToggle />
            </div>
            <Button 
              variant="ghost" 
        ...
        <div className={cn(
          ...
          <nav className="py-4 border-t border-white/10 bg-background/20 backdrop-blur-md rounded-b-xl mx-2 mb-2">
